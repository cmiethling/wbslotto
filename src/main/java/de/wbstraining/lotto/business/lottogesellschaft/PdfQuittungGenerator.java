                ...
                gebueren.forEach((date, gebuehr) -> {
                        table.addCell(
                                        createTextCell(date.format(DateTimeFormatter.ofPattern("dd.MM.yyyy")), 100, TextAlignment.JUSTIFIED)
                                                        .setBorderBottom(new SolidBorder(color, .1f)).setBorderRight(new SolidBorder(color, .1f)));
                        table.addCell(createTextCell(String.valueOf(gebuehr.getEinsatzprotipp()), 100, TextAlignment.JUSTIFIED)
                                        .setBorderBottom(new SolidBorder(color, .1f)).setBorderRight(new SolidBorder(color, .1f)));
                        table.addCell(createTextCell(String.valueOf(gebuehr.getEinsatzspiel77()), 100, TextAlignment.JUSTIFIED)
                                        .setBorderBottom(new SolidBorder(color, .1f)).setBorderRight(new SolidBorder(color, .1f)));
                        table.addCell(createTextCell(String.valueOf(gebuehr.getEinsatzsuper6()), 100, TextAlignment.JUSTIFIED)
                                        .setBorderBottom(new SolidBorder(color, .1f)).setBorderRight(new SolidBorder(color, .1f)));
                });
