...
public class TestdatenGeneratorUtil {
    ...
    public static boolean isMittwoch(Date datum) {
    ...
    public static int generateLosnummer6Aus49(int superzahl, int spiel77, int super6, int gkl) {
    ...
    public static byte[] generateTippsFuerEinenSchein(long zahlenAlsBits, int gkl6Aus49, int anzahlTipps) {
    ...
    private static int replaceDigit(int spiel77OrSuper6, int pos, boolean isSpiel77) {
